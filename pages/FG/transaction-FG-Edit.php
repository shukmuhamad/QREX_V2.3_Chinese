...
foreach($result as $row)
{
  ...
  if($Plant != $T_Lot_FG['PlantName']
   OR $palletID != $T_Lot_FG['PalletID']
   OR $BatchNumber != $T_Lot_FG['BatchNumber']
   OR $SONumber != $T_Lot_FG['SONumber']
   OR $ItemNumber != $T_Lot_FG['SOItemNumber']
   OR $Customer != $T_Lot_FG['CustomerName']
   OR $Brand != $T_Lot_FG['BrandName']
   OR $LotNumber != $T_Lot_FG['LotNumber']
   OR $LotCount != $T_Lot_FG['LotCount']
   OR $InspectionPlan != $T_Lot_FG['InspectionPlanName']
   OR $PalletNumber != $T_Lot_FG['PalletNumber']
   OR $CartonQuantity != $T_Lot_FG['CartonQuantity']
   OR $GloveCode != $T_Lot_FG['GloveCodeLong']
   OR $GloveColour != $oldColourCode
   OR $GloveProductType != $T_Lot_FG['GloveProductTypeName']
   OR $GloveSize != $T_Lot_FG['GloveSizeCodeLong']
   OR $FGCondition != $T_Lot_FG['FGCondition']
  ){
...
//-------------------------------------------------------------------------------------------------------------------------------
          ...
          echo"<script>location.replace('form-FG-Edit.php?LotIDKey=".$lotID."&RecordID=".$RecordID."');</script>";
