        ...
        <div class="col-lg-6">
          ...
          <script>
              $('.inspection_stage').ready(function(){
                var inspection_stage = '<?php echo $Lot_FG['FGCondition'];?>';
    ...
    <div class="row">
      ...
      <div class="col-lg-12">
        ...
        <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
          ...
          <tr>
            <th scope="col" class="info"></th>
            <td><center><a class = "btn btn-success" href = "#" data-toggle="modal" data-target="#regulatoryPackagingModal">法规包装</a></center></td>
            <td><center><a class = "btn btn-success" href = "#" data-toggle="modal" data-target="#criticalPackagingModal">关键包装</a></center></td>
            <td><center><a class = "btn btn-success" href = "#" data-toggle="modal" data-target="#visualPackagingModal">视觉包装</a></center></td>
