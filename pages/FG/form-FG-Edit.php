...
<!------------------------------------------------------- PRODUCT INFORMATION -------------------------------------------------->
                            ...
                            <div class="row">
                              <form role="form" method ="post" id="InspectionForm">
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <div class="form-group">
                                    <label>批数:</label>
                                    <input class="form-control" name="LotCount" id="LotCount" placeholder="Enter Lot Count" value="<?php echo $T_Lot_FG['LotCount']; ?>"required>
                                  </div>
                                  <!-- /.form-group -->
                                  ...
                                  <div class="form-group">
                                    <label>批号:</label>
                                    <input class="form-control" name="BatchNumber" id="BatchNumber" maxlength="40" placeholder="Enter Batch Number" value="<?php echo $T_Lot_FG['BatchNumber']; ?>"required>
                                  ...
                                  <div class="form-group">
                                    <label>托盘编号:</label>
                                    <input type="number" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null;" class="form-control digit" name="PalletNumber" id="PalletNumber" value="<?php echo $T_Lot_FG['PalletNumber']; ?>" >
                                  ...
                                  <div class="form-group">
                                    ...
                                    <label class="checkbox-inline">
                                      <input type="radio" name="RecordStatusFlag" id="RecordStatusFlagRadios2" value="2">&nbsp;复检
                                    </label>
                                    <label class="checkbox-inline">
                                      <input type="radio" name="RecordStatusFlag" id="RecordStatusFlagRadios3" value="3">&nbsp;转换检验
                                    </label>
                                    <label class="checkbox-inline">
                                      <input type="radio" name="RecordStatusFlag" id="RecordStatusFlagRadios4" value="4">&nbsp;重新包装检验
                                    </label>
                                    <script>
                                ...
                                <div class="col-lg-6">
                                  ...
                                  <div class="form-group">
                                    <label>SO 数字:</label>
                                    <input  type="number" oninput="this.value=this.value.slice(0,this.maxLength); this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null;" maxlength="10"  class="form-control" name="SONumber" id="SONumber" value="<?php echo $T_Lot_FG['SONumber']; ?>" >
                                    <div id="checkk"></div>
                                  </div>
                                  <!-- /.form-group -->
                                  ...
                                  <div class="form-group">
                                    <label>Lot 数字:</label>
                                    <input type="input" class="form-control" name="LotNumber" id="LotNumber" value="<?php echo $T_Lot_FG['LotNumber']; ?>" >
                          ...
                          <div class="panel-body">
                            <div class="row">
                              ...
                              <div class="col-lg-12">
                                ...
                                <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                  ...
                                  <tr>
                                    ...
                                    <th scope="col" id="" class="info">UD 处置:</th>
                                    <td>
                              ...
                              <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                  <label>经核实:</label>
                                  <input class="form-control" type="number" min="0" oninput="this.value = !!this.value && Math.abs(this.value) >= 0 ? Math.abs(this.value) : null;" name="verify_by" placeholder="Enter Badge ID" required><br>
                                </div>
                                <!-- /.form-group -->
      ...
      <?php include 'transaction-FG-Edit.php'?>
