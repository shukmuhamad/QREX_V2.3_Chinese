          ...
          <div class="row">
            ...
            <div class="col-lg-6">
                      ...
                      <div class="form-group">
                        ...
                        Lot 伯爵:
                        <label> <?php echo $T_Lot_FG['LotCount']; ?> </label>
                      </div>
                      ...
                      <div class="form-group">
                        尺寸:<label> <?php echo $T_Lot_FG['GloveSizeCodeLong']; ?> </label></br>
                      </div>

                      <div class="form-group">
                        托盘 NO: <label> <?php echo $T_Lot_FG['PalletNumber'];?></label></br>
                      </div>
                      ...
                      <div class="col-lg-6">
                        ...
                        <div class="form-group">
                        项目编号:
                          <label><?php echo $T_Lot_FG['SOItemNumber'];?></label>
                        </div>
				              <div class="form-group">
                        顾客:
                      ...
                      <div class="form-group">
                        产品 :<label><?php echo $T_Lot_FG['GloveProductTypeName'];?></label>
                      </div>

                      <div class="form-group">
                        产品代码: <label><?php echo $T_Lot_FG['GloveCodeLong']; ?></label>
                      </div>

                      <div class="form-group">
                        颜色: <label><?php echo $T_Lot_FG['GloveColourName']; ?></label>
                      </div>
...
<!-----------------------------------------------------------1.INSTRUMENT--------------------------------------------------------------------------->
                      ...
                      <label>1. 仪器</label></br></br>

                        <div class="form-group">
                          秤 ID: <label><?php echo $T_Record_Instrument[0]['InstrumentValue'];?></label>
                        </div>

										    <div class="form-group">
                          统治者 ID:<label> <?php echo $T_Record_Instrument[2]['InstrumentValue'];?> </label>
                        </div>

										    <div class="form-group">
                          测厚仪 ID:<label>  <?php echo $T_Record_Instrument[1]['InstrumentValue'];?></label>
                        </div>
										    <br>
<!-----------------------------------------------------------2. TEST RESULT--------------------------------------------------------------------------->
...
<!-----------------------------------------------------------3. INTERNAL PHYSICAL TESTING ------------------------------------------------------------>                   <!-- /.col-lg-6 (nested) -->
                      <div class="col-lg-4">
                        ...
                        <table class="table table-bordered" id="dataTable" width="20%" cellspacing="0">
                        <tr>
                          <th class="info" rowspan="2">穿戴和撕裂:</th>
                          <th>结果</th>
                          <th>评论</th>
                        </tr>
                        <tr>
...
<!-----------------------------------------------------------4. SPECIAL REQUIREMENT ------------------------------------------------------------------>
                        ...
                        <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
  										    <tr>
                            <div class="form-group">
                            <th scope="col" class="info">测试 No:</th>
                            <th class="info">测试名称:</th>
                            <th scope="col" class="info">处置:</th>
                          </tr>
...
<!----------------------------------------------------------- INSPECTION RECORD --------------------------------------------------------------------->
                  ...
                  <div class="col-lg-12">
                    ...
                    <td><b>**检查计划和级别 </b><a class = "btn btn-default"
                    ...
                    <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                      <tr class="info">
                        <th></th>
                      	<th colspan="2" width="13%">MINOR 视觉的</th>
                      	<th colspan="4" width="30%">MAJOR 视觉的</th>
                      	<th colspan="3" width="18%">危急 NAG</th>
                      	<th colspan="3" width="13%">危急 NFG</th>
                        <th colspan="2" width="13%">孔位自由度 1</th>
                        <th colspan="2" width="13%">孔位自由度 2</th>
                        <th colspan="2" width="13%">好手套</th>
                    	</tr>
  			<tr>
                      ...
                      <tr>
                        <th rowspan="13" scope="col" class="info"> 缺陷</th>
                    ...
                    <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <th scope="col" class="info">整体 AQL:</th>

                        <td><input class="form-control" name="overall_AQL" value="<?php echo $AQLResult_pivot['AQLOverall']?>" disabled></td>

                        <th scope="col" class="info">UD处置:</th>
                    ...
                    <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                      <tr class="info"><br>
                        <th></th>
                        <th colspan="3">法规包装</th>
                        <th colspan="4">关键包装</th>
                        <th colspan="4">视觉包装</th>
                      ...
                      <tr>
                        ...
                        <th scope="col" class="info" rowspan="6"> 缺点</th>
                      ...
                      <tr>
                        ...
                        <td colspan="3"><input class="form-control" name="Result_Regulatory" value="<?php echo $AQLResult_pivot['ResultRegulatoryPackaging'];?>" disabled></td>
                        <td colspan="4"><input class="form-control" name="Result_Critical" value="<?php echo $AQLResult_pivot['ResultCriticalPackaging'];?>" disabled></td>
                        <td colspan="4"><input class="form-control" name="Result_Visual" value="<?php echo $AQLResult_pivot['ResultVisualPackaging'];?>" disabled></td>
                    ...
                    <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                      <tr>
      									...
      									<td><input class="form-control" name="final_disposition" value="<?php echo $AQLResult_pivot['FinalDisposition'];?>" disabled></td>

 										  </tr>
                    </table>

                    <div class="form-group">
                        经核实:<label><?php echo $T_Record_Master['VerifierID'];?></label>
                      </div>

                      <div class="form-group">
                        <?php $date2 = date("d/m/Y h:i:s A", strtotime($T_Record_Master['VerifiedDate'])); ?>
                        日期:<label><?php echo $date2;?></label>
                      </div>
                        ...
                        <?php
                          if($_SESSION['PositionKey']==1){
                            ?>
                            <a class = "btn btn-success" target="_blank" href = "form-FG-Edit.php?LotIDKey=<?php echo $lotID;?>&RecordID=<?php echo $RecordID;?>" > 更新/验证</a>&nbsp;&nbsp;&nbsp;&nbsp;
                        <?php
                          }
                        ?>
                        <?php
                          if($_SESSION['PositionKey']!=2){
                            ?>
                        <a class = "btn btn-warning" target="_blank" href = "form-FG-Reinspect.php?LotIDKey=<?php echo $lotID;?>&RecordID=<?php echo $RecordID;?>" > 重新检查</a>&nbsp;&nbsp;
                        <?php
                          }
                        ?>
			<a target="" href="#" role="button" class="btn btn-primary" title="Print" onClick="window.print()"><i class = "glyphicon glyphicon-print"></i>&nbsp;打印</a>
                      </center><br><br>
                                       </form>
 									</div>
                                </div>
