                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <select class="form-control fstdropdown-select" name="ProductionLineName2">
                                          <option class="form-control" value=""> 线号</option>
                                          <?php
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        ...
        <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
          ...
          <tr>
            <td width="20%" class="info">手套克重:</td>
            <td>
              <label class="checkbox-inline">
      ...
      <div class="col-lg-6">
        ...
        <label>3. 内部物理检验</label>

        <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">

          <tr>
            <th scope="col" class="info">层次测试:</th>
            <td>
              <label class="checkbox-inline">
          ...
          <tr>
            <th scope="col" class="info">握力测试:</th>
            <td>
              <label class="checkbox-inline">
          ...
          <tr>
            <th scope="col" class="info">: 黑布测试:</th>
            <td>
              <label class="checkbox-inline">
          ...
          <tr>
            <th scope="col" class="info">分配测试:</th>
            <td>
              <label class="checkbox-inline">
        ...
        <table class="table table-bordered">
          ...
          <tr>
            <th style=" vertical-align: middle;" class="info" rowspan="2" width="30%">穿戴与撕裂检测:</th>
      ...
      <div class="col-lg-6">
        ...
        <table class="table table-bordered" id="dataTable">
          ...
          <tr>
            ...
            <td>
              <label class="checkbox-inline">
                <input type="radio" name="method" id="optionsRadiosmethod2" value="SINGLE WALL">单层壁
              </label>
              <label class="checkbox-inline">
                <input type="radio" name="method" id="optionsRadiosmethod1" value="DOUBLE WALL">双层壁
              </label>
              <script>
        ...
        <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
          ...
          <tr class="info">
            ...
            <th>PASS/FAIL</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">长度（毫米）:</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">宽度（毫米）:</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">卷边厚度:</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">掌部厚度:</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">指尖厚度:</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">*圆缘直径厚度:</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">*卷边边缘厚度:</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">*手套克重:</th>
                                      ...
                                      <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                          ...
                                          <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                            ...
                                            <tr>
                                              <th scope="col" class="info">水密/吹气测试样本量第一层:</th>
                                              <td><input type="number" min="1" oninput="this.value = !!this.value && Math.abs(this.value) >= 1 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_apt" id="sample_size_apt" value="<?php echo $T_Record_SampleSize[1]['SampleSizeValue']; ?>" ></td>

                                              <th scope="col" class="info">样本量 (外观检验):</th>
                                              <td><input type="number" min="1" oninput="this.value = !!this.value && Math.abs(this.value) >= 1 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_vt" id="sample_size" value="<?php echo $T_Record_SampleSize[0]['SampleSizeValue']; ?>" ></td>
                                            </tr>

                                            <tr>
                                              <th scope="col" class="info">水密/吹气测试样本量第二层:</th>
                                              <td><input type="number" min="1" oninput="this.value = !!this.value && Math.abs(this.value) >= 1 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_apt2" id="sample_size_apt2" placeholder="0" value="<?php echo $T_Record_SampleSize[2]['SampleSizeValue']; ?>"></td>

                                              <th scope="col" class="info">机械号:</th>
                                          ...
                                          <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                            ...
                                            <tr id="countit">
                                              <th scope="col" class="info">缺陷数量</th>
                                            ...
                                            <tr>
                                              <th scope="col" class="info">缺陷总数</th>
                                              <td colspan="7">
                                          ...
                                          <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                            ...
                                            <tr>
                                              ...
                                              <th scope="col" id="" class="info">检验结果判定:</th>
                                              <td>
                                          ...
                                          <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                                            ...
                                            <tr>
                                              <th scope="col" class="info"> 最终检验结果判定:</th>
                                              <td>
                                                <label class="checkbox-inline">
                                    ...
                                    <div class="modal-dialog" role="document">
                                      <div class="modal-content">
                                        <div class="modal-header">
                                          ...
                                          <center><h2 class="modal-title" id="exampleModalLabel">良好手套</h2></center>
                                        </div>
