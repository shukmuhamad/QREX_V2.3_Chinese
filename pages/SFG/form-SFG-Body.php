  ...
  <body>
    <div id="wrapper">
      ...
      <div id="page-wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h1 class="page-header">SFG 表格</h1>
          </div>
          <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                ...
                <div class="col-lg-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control fstdropdown-select" name="InspectionPlanName" required></td>
                      <option class="form-control"  value=""> 类别</option>
                      <?php foreach ($fetch as $row) {
                  ...
                  <div class="form-group">
                    ...
                    <label class="checkbox-inline">
                      <input type="radio" name="RecordStatusFlag" id="optionsRadios2" value="2">&nbsp;复检
                    </label>
                    <label class="checkbox-inline">
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" id="shift1" name="shift1" required>
                          ...
                          <option name="shift1" value="1"> 移 1</option>
                          <option name="shift1" value="2"> 移 2</option>
                          <option name="shift1" value="3"> 移 3</option>
                        </select>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" id="shift2" name="shift2">
                          ...
                          <option class="form-control" name="shift2" value="1"> 移 1 </option>
                          <option class="form-control" name="shift2" value="2"> 移 2 </option>
                          <option class="form-control" name="shift2" value="3"> 移 3 </option>
                        </select>
                      </td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>
                        <select class="form-control" id="shift3" name="shift3" >
                          ...
                          <option class="form-control" name="shift3" value="1"> 移 1</option>
                          <option class="form-control" name="shift3" value="2"> 移 2</option>
                          <option class="form-control" name="shift3" value="3"> 移 3 </option>
                        </select>
                      </td>
                    </tr>
              ...
              <div class="col-lg-6">
                ...
                <table class="table table-bordered" id="dataTable">
                  ...
                  <tr>
                    ...
                    <td>
                      <label class="checkbox-inline">
                        <input type="radio" name="method" id="optionsRadios1" value="SINGLE WALL" checked>单墙
                      </label>
                      <label class="checkbox-inline">
                        <input type="radio" name="method" id="optionsRadios1" value="DOUBLE WALL">双墙
                      </label>
                    </td>
                  </tr>
            ...
            <div class="row">
              ...
              <div class="col-lg-12">
                ...
                <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                  ...
                  <tr>
                    <th scope="col" class="info">样本量 APT/WTT (LEVEL 1):</th>
                    <td><input type="number" min="1" oninput="this.value = !!this.value && Math.abs(this.value) >= 1 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_apt" id="sample_size_apt" placeholder="0" ></td>

                    <th scope="col" class="info">样本量 VT:</th>
                    <td><input type="number" min="1" oninput="this.value = !!this.value && Math.abs(this.value) >= 1 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_vt" id="sample_size" placeholder="0" ></p></td>
                  </tr>

                  <tr>
                    <th scope="col" class="info">样本量 APT/WTT (LEVEL 2):</th>
                    <td><input type="number" min="1" oninput="this.value = !!this.value && Math.abs(this.value) >= 1 ? Math.abs(this.value) : null;" class="form-control digit" name="sample_size_apt2" id="sample_size_apt2" placeholder="0" ></td>
                ...
                <br><br><br><br>
                  ...
                  <li style="float: left;"><a class="btn btn-default" href="../pdf/GL PQC S07 Inspection Plan 1.1 Published.pdf" target="iframe_i">演出</a></li>
                ...
                <table class="table table-bordered" id="dataTable" width="30%" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <th scope="col" class="info">UD 处置:</th>
                    <td>
              ...
              <center>
                <button type="submit" name="submit" form="InspectionForm" class="btn btn-primary" style="margin-bottom: 20px;">节省</button>
              </center>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <center><h2 class="modal-title" id="exampleModalLabel">Critical 包装</h2></center>
              </div>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <center><h2 class="modal-title" id="exampleModalLabel">Visual 包装</h2></center>
              </div>
